...
//             { text: "Good god. You're an unususal looking specimen, aren't you, Mr. Parker?", nextScene: 3 }
//         ]
//     },
//     {
//         speaker: "counterpart",
...
//             { text: "We'd like to propose a more reasonable approach: a targeted recall program plus a $50 million compensation fund for verified damages.", nextScene: 7 },
...
function calculateExpectedValues() {
    ...
    const courtProbability = formData.goToCourt ? 1.0 : 0.0;
    ...
    if (formData.goToCourt) {
        payneEV = -courtCostPayneMotors - prDamageCost; // $900M court cost + $100M PR damage
        plaintiffEV = courtCostPayneMotors * 0.9; // Plaintiffs get 90% after lawyer fees
        ...
        if (formData.recall) {
            ...
            plaintiffEV += totalCompensation * 0.7; // Plaintiffs get 70% after lawyer fees
